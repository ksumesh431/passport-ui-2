...
export const ContactForm = () => {
    ...
    return (
        <div className="w-full min-w-[65%] max-w-[95%] sm:max-w-[85%] md:max-w-2xl mx-auto bg-white rounded-3xl shadow-lg overflow-hidden p-4 sm:p-6 md:p-8 mb-5">
            <h1 className="text-xl sm:text-2xl font-semibold text-white bg-primary -mx-4 sm:-mx-6 md:-mx-8 -mt-4 sm:-mt-6 md:-mt-8 p-4 sm:p-6 mb-4 sm:mb-6 md:mb-8">
                Raise a Query
            </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        onBlur={handleBlur}
                        className="w-full p-2 sm:p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-800"
                    />
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        className="w-full p-2 sm:p-3 border border-gray-300 rounded-lg h-32 focus:ring-2 focus:ring-blue-800"
                    />
                </div>
                ...
                <button
                    ...
                    className="w-full bg-primary text-white py-4 px-6 rounded-lg hover:bg-blue-600 disabled:bg-gray-400 text-lg font-medium"
                >
            ...
            <div className="relative mb-16">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-8 mx-4 md:mx-auto max-w-3xl -mt-8 relative z-10">
                    <div className="flex flex-col sm:flex-row justify-around items-center space-y-4 sm:space-y-0">
                        ...
                        <div className="flex items-center w-full sm:w-auto justify-center">
                            <div className="bg-green-400 p-2 sm:p-3 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
