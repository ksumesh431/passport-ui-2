  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-16">
      ...
      <div className="max-w-5xl mx-auto space-y-8 mt-8 px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-indigo-800 mb-3">1. Tourist Visas</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-indigo-800 mb-3">2. Business Visas</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-indigo-800 mb-3">3. Student Visas</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-indigo-800 mb-3">4. Work Visas</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-indigo-800 mb-3">5. Family Visas</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-indigo-800 mb-3">6. Transit Visas</h3>
          ...
          <div className="p-8">
            <div className="space-y-6">
              <div className="space-y-6">
                ...
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-indigo-800 mb-3">Step 2: Document Checklist and Preparation</h3>
                ...
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-indigo-800 mb-3">Step 3: Application Form Filling</h3>
                ...
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-indigo-800 mb-3">Step 4: Review and Submission</h3>
                ...
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-indigo-800 mb-3">Step 5: Interview Preparation and Appointment Scheduling</h3>
                ...
                <div className="mb-6">
                  <h3 className="text-xl font-bold text-indigo-800 mb-3">Step 6: Follow-up and Tracking</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-indigo-800 mb-3">Extended Stay or Visa Renewals</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-8">
            <h2 className="text-2xl font-bold text-indigo-800 mb-4">Start Your Visa Application Today!</h2>
