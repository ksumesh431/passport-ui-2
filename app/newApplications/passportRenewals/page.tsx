      ...
      <div className="max-w-5xl mx-auto space-y-8 mt-8 px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">1. Expertise You Can Rely On</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">2. Fast and Efficient Service</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">3. Comprehensive Guidance</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">4. End-to-End Support</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">5. Guaranteed Accuracy</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">Step 3: Application Submission</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">Step 4: Tracking & Updates</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">Step 5: Passport Delivery</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">New Passport Applications</h3>
              ...
              <div>
                <h3 className="text-xl font-bold text-primary mb-3">Passport Renewals</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          <div className="p-8">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-6 border border-indigo-100">
              <h3 className="text-xl font-bold text-primary mb-4">Start Your Application Now!</h3>
