          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="border border-gray-200 rounded-lg p-4">
                <h3 className="text-xl font-semibold text-primary mb-2">Platforms We Cover</h3>
          ...
          <div className="p-8">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-6 border border-indigo-100">
              <p className="text-lg font-medium text-primary mb-6">
                Reach out to DocoAid for professional chat translation services. Our team is ready to help you translate your digital communications accurately and efficiently.
              </p>
              <ContactUsButton />
            </div>
          </div>
